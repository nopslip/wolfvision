...
export class WOLFV2__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class WOLFV2 extends ethereum.SmartContract {
  static bind(address: Address): WOLFV2 {
    return new WOLFV2("WOLFV2", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): WOLFV2__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new WOLFV2__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<WOLFV2__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new WOLFV2__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
